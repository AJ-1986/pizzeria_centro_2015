...
<html lang="pl">
    <head>        
        ...
        <title>Pizzeria Centro - Przekąski</title>        
            ...
            <div class="text_area">
                ...
                <table>
                    ...
                    <tr style="background-color: #720000">
                        <td class="biala">2. Gorące pieczywo czosnkowe</td>
                        <td class="biala" style="text-align: right">4.00</td>
                    </tr>
                    <tr>
                        <td>3. Hamburger</td>
                        <td style="text-align: right">5.00</td>
