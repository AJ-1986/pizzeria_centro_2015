...
<html lang="pl">
    ...
    <body>
        ...
        <div class="main_page">
            ...
            <div class="text_area">
                <h1 class="m_title">Witamy na stronie Pizzerii Centro</h1>
                <p class="m_tekst">
                    Witamy na stronie internetowej Pizzerii Centro. Jesteśmy pierwszą pizzerią w Kętrzynie. Działamy od 1998 roku.<br /><br />
                    Lokal nasz znajduje się w ścisłym centrum Kętrzyna przy ul. Sikorskiego 21. Idealne miejsce na szybki lunch, spotkanie biznesowe czy randkę.<br /><br />
                    W obrębie lokalu dostępna jest dla klientów bezpłatna sieć Wi-Fi. Za wszelkie usługi i produkty zapłacisz również kartą płatniczą. Obsługujemy większość występujących kart na rynku.<br /><br />
                    W ofercie menu posiadamy bogatą ofertę pizzy, makaronów zapiekanych z pieca, sałatek, przekąsek oraz dań azjatyckich. Nie zabraknie również bardzo dobrze wyposażonego baru w markowe trunki.<br /><br />
                    Zapraszamy do zapoznania się z naszą kartą menu. 
                </p>
            </div>
            <div class="footer">
