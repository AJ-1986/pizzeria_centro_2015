...
<html lang="pl">
    <head>        
        ...
        <title>Pizzeria Centro - Dania mięsne</title>        
    ...
    <body>
        ...
        <div class="main_page">
            ...
            <div class="text_area">
                <h1 class="m_title">Dania mięsne</h1>
                <p class="m_tekst2">Potrawy z mięsa wieprzowego - <i>wg wagi 100g</i></p>
                <table>
                    <tr>
                        <td>1. Scaloppina Hawaii<br />&nbsp;&nbsp;&nbsp;&nbsp;Sznycel z szynką, serem, ananasem i sosem śmietanowym</td>
                        <td style="text-align: right">18.00</td>
                    </tr>
                    <tr style="background-color: #720000">
                        <td class="biala">2. Scaloppina Sicilia<br />&nbsp;&nbsp;&nbsp;&nbsp;Sznycel w sosie pomidorowym z cebulą</td>
                        <td class="biala" style="text-align: right">16.00</td>
                    </tr>
                    <tr>
                        <td>3. Scaloppina al Vino bianco<br />&nbsp;&nbsp;&nbsp;&nbsp;Sznycel w sosie winnym</td>
                        <td style="text-align: right">16.00</td>
                    </tr>
                    <tr style="background-color: #720000">
                        <td class="biala">4. Sznycel wiedeński panierowany</td>
                        <td class="biala" style="text-align: right">13.00</td>
                    </tr>
                    <tr>
                        <td>5. Sznycel z grilla z ananasem</td>
                        <td style="text-align: right">14.00</td>
                    </tr>
                    <tr style="background-color: #720000">
                        <td class="biala">6. Karkówka z grilla</td>
                        <td class="biala" style="text-align: right">14.00</td>
                    </tr>                                        
                </table>
                <p class="m_tekst2">Potrawy z mięsa wołowego - <i>wg wagi 100g</i></p>
                <table>
                    <tr>
                        <td>7. Filetto al Porcini Funghi<br />&nbsp;&nbsp;&nbsp;&nbsp;Polędwica, grzyby, makaron w śmietanie</td>
                        <td style="text-align: right">45.00</td>
                    </tr>
                    <tr style="background-color: #720000">
                        <td class="biala">8. Filetto alla Griglia<br />&nbsp;&nbsp;&nbsp;&nbsp;Polędwica z grilla</td>
                        <td class="biala" style="text-align: right">35.00</td>
                    </tr>
                    <tr>
                        <td>9. Filetto al Funghi<br />&nbsp;&nbsp;&nbsp;&nbsp;Polędwica z pieczarkami</td>
                        <td style="text-align: right">40.00</td>
                    </tr>
                </table>
                <p class="m_tekst2">Potrawy z kurczaka - <i>wg wagi 100g</i></p>
                <table>
                    <tr>
                        <td>10. Sznycel drobiowy z grilla</td>
                        <td style="text-align: right">11.00</td>
                    </tr>
                    <tr style="background-color: #720000">
                        <td class="biala">11. Sznycel drobiowy w sosie śmietanowym</td>
                        <td class="biala" style="text-align: right">14.00</td>
                    </tr>
                    <tr>
                        <td>12. Sznycel drobiowy z grilla z ananasem</td>
                        <td style="text-align: right">15.00</td>
                    </tr>
                    <tr style="background-color: #720000">
                        <td class="biala">13. Skrzydełka z kurczaka (6 szt.) + pieczywo czosnkowe</td>
                        <td class="biala" style="text-align: right">16.00</td>
                    </tr>
                    <tr>
                        <td>14. Skrzydełka zestaw (6 skrzydełek + frytki + surówka)</td>
                        <td style="text-align: right">17.00</td>
                    </tr>
                </table>
                <p class="m_tekst2">Zupy - <i>250 ml</i></p>
                <table>
                    <tr>
                        <td>15. Flaczki</td>
                    ...
                    <tr style="background-color: #720000">
                        <td class="biala">16. Gulasz</td>
                        <td class="biala" style="text-align: right">9.00</td>
                    </tr>
                    <tr>
                        <td>17. Zupa gulaszowa</td>
                        <td style="text-align: right">9.00</td>
                    </tr>
                    <tr style="background-color: #720000">
                        <td class="biala">18. Żurek</td>
                        <td class="biala" style="text-align: right">8.00</td>
                    </tr>
                </table>
